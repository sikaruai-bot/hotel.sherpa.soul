...
const DEFAULT_CMS_DATA = {
  ...
  seo: {
    global: {
      defaultTitle: "Hotel Sherpa Soul | Boutique Stay in Thamel, Kathmandu, Nepal",
      defaultDescription: "Stay at Hotel Sherpa Soul, a peaceful hotel in Thamel, Kathmandu. Comfortable rooms, air conditioning, Wi-Fi, friendly service and practical facilities for travellers. No Restaurant. No Noise. Sleep Well.",
      defaultKeywords: "Hotel Sherpa Soul, Hotel in Thamel, Kathmandu Hotel, Boutique Hotel Nepal, Budget Hotel Thamel, Thamel Accommodation, Stay in Kathmandu",
    ...
    pages: {
      "/": {
        title: "Hotel Sherpa Soul | Boutique Stay in Thamel, Kathmandu, Nepal",
        description: "Stay at Hotel Sherpa Soul, a peaceful hotel in Thamel, Kathmandu. Comfortable rooms, air conditioning, Wi-Fi, friendly service and practical facilities for travellers. No Restaurant. No Noise. Sleep Well.",
        keywords: "Hotel Sherpa Soul, Boutique Hotel Thamel, Kathmandu Hotel, Sleep Well Thamel",
        ogImage: "https://hotelsherpasoul.com/hero1.webp",
      },
      "/about": {
        title: "About Us | Hotel Sherpa Soul Thamel, Kathmandu",
        description: "Discover Hotel Sherpa Soul's philosophy: No Restaurant. No Noise. Sleep Well. A peaceful haven in the heart of Kathmandu with genuine Sherpa warmth.",
        keywords: "About Hotel Sherpa Soul, Sherpa hospitality Kathmandu, Peaceful hotel Thamel",
        ogImage: "https://hotelsherpasoul.com/hero1.webp",
      },
      "/rooms": {
      ...
      "/contact": {
        title: "Contact & Location | Hotel Sherpa Soul Thamel Kathmandu",
        description: "Get in touch with Hotel Sherpa Soul. Conveniently located in Thamel Bhagawati Marg, Kathmandu. 24/7 front desk and fast WhatsApp support.",
        keywords: "Hotel Sherpa Soul Contact, Location Thamel Kathmandu, Phone WhatsApp",
        ogImage: "https://hotelsherpasoul.com/hero1.webp",
      },
      "/services": {
      ...
      "/blog": {
        title: "Stories & Travel Guide | Hotel Sherpa Soul Blog",
        description: "Kathmandu travel tips, trekking guides, and stories from the heart of Thamel by Hotel Sherpa Soul.",
        keywords: "Kathmandu travel blog, Nepal trekking tips, Thamel travel guide",
        ogImage: "https://hotelsherpasoul.com/hero1.webp",
      },
    },
    social: {
